...
const Show = ({auth, document, AccessDenied}) => {
    ...
    return (
        ...
        >
            ...
            <span className={"text-sm"}>Статус: <span className={`${document.status==="created" ? 'bg-amber-500' : document.status==="in_review" ? "bg-yellow-400" : "bg-green-500"} px-2 py-1 rounded`}> {document.status}</span></span>
